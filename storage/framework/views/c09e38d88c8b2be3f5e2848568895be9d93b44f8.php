                ...
                <div class="card-header">
                    <form class="p-3" action="<?php echo e(route('admin.marketplacesreport')); ?>" method="get">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('نوع الفواتير')); ?></label>
                                    <select name="type" class="form-control" id="">
                                        <option value="">
                                            كل الانواع
                                            <span><?php echo e(@App\Models\Invoice::all()->count()); ?></span>
                                        </option>
                                        <option value="raw">
                                            كتابية
                                            <span><?php echo e(@App\Models\Invoice::all()->where('IsRaw',1)->count()); ?></span>
                                        </option>
                                        <option value="sale">
                                            الكترونية
                                            <span><?php echo e(@App\Models\Invoice::all()->where('IsRaw',0)->count()); ?></span>
                                        </option>
                                    </select>
                                </div>
                            </div>
