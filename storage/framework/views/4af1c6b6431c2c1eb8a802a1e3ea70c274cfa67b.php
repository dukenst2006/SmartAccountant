...
<?php $__env->startSection('title', 'الإعدادات العامة'); ?>
                    ...
                    <form action="<?php echo e(route('admin.settings.update', '1')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <div class="row">
                                    <div class="col-sm-9">
                                        <?php echo Form::label('AbsenceDiscountValue', __('General.AbsenceDiscount.AbsenceDiscountValue')); ?>

                                        <?php echo Form::number('AbsenceDiscountValue', $setting->AbsenceDiscountValue, ['class' => 'form-control']); ?>

                                    </div>
                                    <div class="col-sm-3">
                                        <?php echo Form::label('AbsenceDiscountType', __('General.AbsenceDiscount.AbsenceDiscountType')); ?>

                                        <?php echo Form::select('AbsenceDiscountType',[ 'Value' => __('General.AbsenceDiscount.Types.Value'), 'Rate' => __('General.AbsenceDiscount.Types.Rate') ], $setting->AbsenceDiscountType,['class' => 'form-control']); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel-Projects\Smart Accountant\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>