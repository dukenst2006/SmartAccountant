...
<div class="main-tbl" style="overflow:auto;">
    <table class="table table-striped" style="min-width: 1000px">
        ...
        <tr>
            <td>               
                <a title="عرض" href="<?php echo e(route('admin.sale_invoice.show', $invoice->id)); ?>" class="" style="color: #e87c85">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/smart-acc.io/resources/views/admin/Invoices/sale_invoices_index.blade.php ENDPATH**/ ?>