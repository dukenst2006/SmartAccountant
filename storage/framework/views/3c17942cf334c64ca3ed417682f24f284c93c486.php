            ...
            <table class="table table-bordered text-center">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th><?php echo e(__('Models/Expenses.Name')); ?></th>
                        <th><?php echo e(__('Models/Expenses.Description')); ?></th>
                        <th><?php echo e(__('Models/Expenses.Date')); ?></th>
                        <th><?php echo e(__('Models/Expenses.ExpensesMainCategory')); ?></th>
                        <th><?php echo e(__('Models/Expenses.ExpensesSubCategory')); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__currentLoopData = $expensesTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $E): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($E->expensescategory->Name); ?></td>
                            <td><?php echo e($E->expensessubcategory->Name); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
