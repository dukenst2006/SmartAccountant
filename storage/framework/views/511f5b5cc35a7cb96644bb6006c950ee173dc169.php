            ...
            <div class="col-10">
                <div class="card" style="font-family: 'Cairo', sans-serif;font-weight: 900;">
                    <div class="card-header">
                        <h3 class="card-title">تعديل فاتورة كود: <?php echo e($invoice->invoice_code); ?></h3>
                    </div>
                    
                    <div class="card-body p-0 ">
                        <?php echo Form::open(['route' => ['admin.raw_invoice.update', $invoice->id], 'method' => 'put']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::select('MarketplaceID',$marketplaces, $invoice->MarketplaceID,['class' => 'form-control']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::select('PaymentTypeID',$payment_types, $invoice->PaymentTypeID,['class' => 'form-control']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::text('CustomerName', $invoice->CustomerName, ['class' => 'form-control']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::text('Total', $invoice->Total, ['class' => 'form-control']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::text('Paid', $invoice->Paid, ['class' => 'form-control']); ?>
                            ...
                            <div class="form-group row col-sm-6 m-3">
                                ...
                                <?php echo Form::text('Rest', $invoice->Rest, ['class' => 'form-control']); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/smart-acc.io/resources/views/admin/Invoices/edit_raw_invoice.blade.php ENDPATH**/ ?>