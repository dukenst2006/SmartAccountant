            ...
            <div class="card-body card-body table-responsive p-0">
                ...
                <div class="text-center">
                    <table class="table table-striped" style="min-width: 1000px">
                        ...
                        <tr>
                            <td>
                                <a title="عرض" href="<?php echo e(route('admin.supplier-invoice.show', $invoice->id)); ?>" class='btn btn-warning btn-sm' style="color: #ffffff">
                            ...
                            <td>
                                ...
                                <a title="تعديل" href="invoice-raw/<?php echo e($invoice->id); ?>/edit" class="text-info"><i class="fas fa-pencil-alt"></i></a>
                                <?php echo Form::open(['route' => ['admin.supplier-invoice.destroy', $invoice->id], 'method' => 'delete']); ?>
