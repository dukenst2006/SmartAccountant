        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-bordered text-center">
                    ...
                    <th><?php echo e(__("عدد مرات البيع")); ?></th>
                    <th><?php echo e(__("قيمة الارباح من المنتج")); ?></th>
                    </thead>
                    <tbody>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $P): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($P->invoices->count()); ?></td>
                            <td><?php echo e($P->invoices->count() * ( $P->SellingPrice - $P->PurchasingPrice)); ?></td>
                        </tr>
