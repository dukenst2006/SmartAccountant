    ...
    <div class="row justify-content-center">
        ...
        <div class="card col-12">
            ...
            <div class="col-12 text-left">
                <form action="<?php echo e(route('ProductImport')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <a class="btn btn-success" href="<?php echo e(route('ProductExport')); ?>">Export</a>
                </form>
            </div>
            <div class="card-body card-body table-responsive p-0">
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\SmartAccountant\resources\views/admin/warehouses/index.blade.php ENDPATH**/ ?>