    ...
    <a class="nav-link <?php echo e($item['class']); ?> <?php if(isset($item['shift'])): ?> <?php echo e($item['shift']); ?> <?php endif; ?>"
       ...
       <?php echo $item['data-compiled'] ?? ''; ?>>
        ...
        <?php if($obLevel ==8): ?>
            ...
            <i class="fas fa-angle-double-<?php echo e((app()->getLocale() == "ar") ? 'left':'right'); ?>"></i>
        <?php endif; ?>
...
<?php /**PATH /home/abcconsttech/public_html/SmartAccountant/resources/views/vendor/adminlte/partials/sidebar/menu-item-link.blade.php ENDPATH**/ ?>