 ...
 *
 * @property \App\Models\Admin\ExpensesCategory $expensescategoryid
...
class ExpensesSubCategory extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Admin\ExpensesCategory::class, 'ExpensesCategoryID');
    }
    ...
    {
        return $this->hasMany(\App\Models\Admin\Expense::class, 'ExpensesSubCategoriesID');
    }
}
