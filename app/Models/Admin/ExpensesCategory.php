...
class ExpensesCategory extends Model
{
    ...
    {
        return $this->hasMany(\App\Models\Admin\Expense::class, 'ExpensesCategoriesID');
    }
    ...
    {
        return $this->hasMany(\App\Models\Admin\ExpensesSubCategory::class, 'ExpensesCategoryID');
    }
}
